...
<body>
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                <th scope="col" class="px-6 py-3 text-left text-base font-normal text-gray-500 tracking-wider">
                    Name
                </th>
                <th scope="col" class="px-6 py-3 text-left text-base font-normal text-gray-500 tracking-wider">
                    Date of birth
                ...
                <th scope="col-span-2" class="px-6 py-3 text-left text-base font-normal text-gray-500 tracking-wider">
                    Nationality
                </th>
                <th scope="col-span-2" class="px-6 py-3 text-left text-base font-normal text-gray-500 tracking-wider">
