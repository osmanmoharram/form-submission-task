...
<div class="w-full h-full bg-no-repeat object-cover"
    ...
    <div class="w-screen h-screen bg-white/80 flex items-center justify-center">
        <div>
            @if ($errors->any())
                <ul class="py-3 px-4 text-base rounded font-normal bg-red-100 text-red-900 space-y-2">
            ...
            <form class="mt-16" action="{{ route('login') }}" method="post" enctype="application/x-www-form-urlencoded">
                @csrf
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <div class="mt-14 flex flex-col justify-center items-center space-y-5">
